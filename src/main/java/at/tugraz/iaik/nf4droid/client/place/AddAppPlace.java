 ...
 */
public class AddAppPlace extends Place {

	/**
	 * PlaceTokenizer knows how to serialize the Place's state to a URL token.
	 */
	@Prefix("addApp")
	public static class Tokenizer implements PlaceTokenizer<AddAppPlace> {

		@Override
		public String getToken(AddAppPlace place) {
			return null;
		}

		@Override
		public AddAppPlace getPlace(String token) {
			return new AddAppPlace();
		}
